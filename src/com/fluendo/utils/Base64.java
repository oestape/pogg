...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static String encodeBytes( byte[] source ) {
        ...
        try {
            ...
            Debug.error("Exception on Base64", ex);
        }   // end catch
        if(encoded==null) Debug.error("Variable encoded is null in encodeBytes");
        return encoded;
    }   // end encodeBytes
    ...
    public static byte[] encodeBytesToBytes( byte[] source ) {
        ...
        try {
            ...
            Debug.error("IOExceptions only come from GZipping, which is turned off", ex);
        }
        return encoded;
    }
